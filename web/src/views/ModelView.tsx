...
import { firstIn, parseTaxonomy, statusMeta } from '../lib/derive';
...
export function ModelView() {
  ...
  const M = app.model;
  const entities = [
    { kind: 'regulation', label: 'Regulations', count: M.regs.length, color: 'var(--reg)', prefix: 'regulations/' },
    { kind: 'requirement', label: 'Requirements', count: M.requirements.length, color: 'var(--prod)', prefix: 'requirements/' },
    { kind: 'spec', label: 'Specs', count: M.specs.length, color: 'var(--text)', prefix: 'specs/' },
    { kind: 'data_mapping', label: 'Data mappings', count: M.maps.length, color: 'var(--data)', prefix: 'data-mappings/' },
    { kind: 'change', label: 'Changes', count: M.changes.length, color: 'var(--ai)', prefix: 'changes/' },
  ];
